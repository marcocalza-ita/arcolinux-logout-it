...
def GUI(self, Gtk, GdkPixbuf, working_dir, os, Gdk, fn):
    ...
    lbl8 = Gtk.Label(label="Opacità:")
    lbl9 = Gtk.Label(label="Grandezza Icone:")
    lbl10 = Gtk.Label(label="Tema:")
    lbl11 = Gtk.Label(label="Grandezza Testo:")
    ...
    btn = Gtk.Button(label="Salva Settaggio")
    ...
    plbl = Gtk.Label()
    plbl.set_markup("<span size=\"large\">Puoi cambiare lo sfondo della schermata di blocco\nusando <b>Arcolinux BetterLockScreen</b></span>")

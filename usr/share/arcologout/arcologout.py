...
class TransparentWindow(Gtk.Window):
    ...
    def on_mouse_in(self, widget, event, data):
        if data == self.binds.get('shutdown'):
            ...
            self.lbl1.set_markup("<span size=\"" + str(self.font) + "000\" foreground=\"" + self.hover + "\">Spegni (S)</span>")
            ...
            self.lbl2.set_markup("<span size=\"" + str(self.font) + "000\" foreground=\"" + self.hover + "\">Riavvia (R)</span>")
            ...
            self.lbl3.set_markup("<span size=\"" + str(self.font) + "000\" foreground=\"" + self.hover + "\">Sospendi (U)</span>")
            ...
            self.lbl4.set_markup("<span size=\"" + str(self.font) + "000\" foreground=\"" + self.hover + "\">Blocca (K)</span>")
            ...
            self.lbl5.set_markup("<span size=\"" + str(self.font) + "000\" foreground=\"" + self.hover + "\">Esci (L)</span>")
            ...
            self.lbl6.set_markup("<span size=\"" + str(self.font) + "000\" foreground=\"" + self.hover + "\">Cancella (ESC)</span>")
            ...
            self.lbl7.set_markup("<span size=\"" + str(self.font) + "000\" foreground=\"" + self.hover + "\">Iberna (H)</span>")
    ...
    def on_mouse_out(self, widget, event, data):
        if not self.active:
            if data == self.binds.get('shutdown'):
                ...
                self.lbl1.set_markup("<span size=\"" + str(self.font) + "000\">Spegni</span>")
            elif data == self.binds.get('restart'):
                pr = GdkPixbuf.Pixbuf().new_from_file_at_size(
                ...
                self.lbl2.set_markup("<span size=\"" + str(self.font) + "000\">Riavvia</span>")
            elif data == self.binds.get('suspend'):
                ps = GdkPixbuf.Pixbuf().new_from_file_at_size(
                ...
                self.lbl3.set_markup("<span size=\"" + str(self.font) + "000\">Sospendi</span>")
            elif data == self.binds.get('lock'):
                plk = GdkPixbuf.Pixbuf().new_from_file_at_size(
                ...
                self.lbl4.set_markup("<span size=\"" + str(self.font) + "000\">Blocca</span>")
            elif data == self.binds.get('logout'):
                plo = GdkPixbuf.Pixbuf().new_from_file_at_size(
                ...
                self.lbl5.set_markup("<span size=\"" + str(self.font) + "000\">Esci</span>")
            elif data == self.binds.get('cancel'):
                plo = GdkPixbuf.Pixbuf().new_from_file_at_size(
                ...
                self.lbl6.set_markup("<span size=\"" + str(self.font) + "000\">Cancella</span>")
            elif data == self.binds.get('hibernate'):
                plo = GdkPixbuf.Pixbuf().new_from_file_at_size(
                ...
                self.lbl7.set_markup("<span size=\"" + str(self.font) + "000\">Iberna</span>")
            elif data == self.binds.get('settings'):
                pset = GdkPixbuf.Pixbuf().new_from_file_at_size(
